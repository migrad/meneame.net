...
class SearchSphinx implements iSearch
{

    public function search($by_date = false, $start = 0, $count = 50)
    {
        return $this->sphinx_do_search($by_date, $start, $count);
    }

    public function sphinx_client()
    {
        global $globals, $db;
    ...
    private function sphinx_do_search($by_date = false, $start = 0, $count = 10, $proximity = true)
    {
        global $globals;
    ...
    private function sphinx_doc_hits($q, $index = 'links')
    {
        global $globals;
