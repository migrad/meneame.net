...
CREATE TABLE `links` (
 ...
 FULLTEXT KEY `link_title` (`link_title`),
 FULLTEXT KEY `link_content` (`link_content`),
 FULLTEXT KEY `link_tags` (`link_tags`),
 FULLTEXT KEY `text_fields` (`link_tags`,`link_content`,`link_title`,`link_url`),
 FULLTEXT KEY `link_url` (`link_url`)
